...
const ApproveUcenik = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:8080/admin/zahtjevi/tempUcenik')
    ...
    const handleApprove = (email) => {
        fetch(`http://localhost:8080/admin/zahtjevi/tempUcenik/${email}/odobri`, {
            method: 'POST',
        })
        .then(response => {
            if (response.ok) {
    ...
    const handleReject = (email) => {
        fetch(`http://localhost:8080/admin/zahtjevi/tempUcenik/${email}`, {
            method: 'DELETE',
        })
        .then(response => {
            if (response.ok) {
        ...
        <div className="homepage">
            ...
            <div className="homepage-container">
                ...
                <div className="main-content">
                    <h2>Zahtjevi za registraciju učenika</h2>
                    {loading && <p>Loading...</p>}
                    {error && <p>{error}</p>}
                    {!loading && !error && (
